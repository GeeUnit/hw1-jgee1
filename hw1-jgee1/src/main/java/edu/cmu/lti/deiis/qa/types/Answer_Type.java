 ...
 * @generated
 */
public class Answer_Type extends StatementBase_Type {
  /** @generated */
  @Override
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.deiis.qa.types.Answer");
  ...
  public boolean getIsCorrect(int addr) {
    if (featOkTst && casFeat_isCorrect == null)
      jcas.throwFeatMissing("isCorrect", "edu.cmu.lti.deiis.qa.types.Answer");
